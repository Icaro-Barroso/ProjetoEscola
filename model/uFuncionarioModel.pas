...
type
  ...
  public
    ...
    property FuncionarioSalario: string read FFuncionarioSalario write SetFuncionarioSalario;
    property FuncionarioCargo: string read FFuncionarioCargo write SetFuncionarioCargo;
    property CodigoSerie: integer read FCodigoSerie write SetCodigoSerie;
    property CodigoEspecialidade: integer read FCodigoEspecialidade write SetCodigoEspecialidade;
    property NomeFuncionario: string read FNomeFuncionario write SetNomeFuncionario;
    property EnderecoFuncionario: string read FEnderecoFuncionario write SetEnderecoFuncionario;
    property DocumentoFuncionario: string read FDocumentoFuncionario write SetDocumentoFuncionario;
  end;
...
procedure TFuncionario.SetCodigoSerie(const Value: integer);
begin
    FCodigoSerie := Value;
end;
